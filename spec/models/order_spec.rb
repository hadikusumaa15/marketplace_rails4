...
describe Order do
  ...
  # total sudah diisi dengan nilai 0
  it { should_not validate_presence_of :total}
  # karena set total sudah dilakukan sebelum validasi
  # maka ini tak diperlukan:
  it { should_not validate_numericality_of(:total).is_greater_than_or_equal_to(0) }
...
# brspec spec/models/order_spec.rb